...
app.post('/api/log', (req, res) => {
    const { rt, trial_type, trial_index, time_elapsed, internal_node_id, subject, response } = req.body;
  
    const newLog = new varlog({ rt, trial_type, trial_index, time_elapsed, internal_node_id, subject, response });
